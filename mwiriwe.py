...
#                                Greet's To
#                              IcoDz - Canejo
#                             Tool For Automated web app testing
#                             Author : dgatwist
...
configFile = installDir + "/mwiriwe.cfg"
print(installDir)
config = ConfigParser.RawConfigParser()
config.read(configFile)

toolDir = installDir + config.get('mwiriwe', 'toolDir')
logDir = installDir + config.get('mwiriwe', 'logDir')
yes = config.get('mwiriwe', 'yes').split()
color_random=[color.HEADER,color.IMPORTANT,color.NOTICE,color.OKBLUE,color.OKGREEN,color.WARNING,color.RED,color.END,color.UNDERLINE,color.LOGGING]
random.shuffle(color_random)
mwiriwelogo = color_random[0] + '''
        ...
        '''
mwiriwePrompt = "mwiriwe ~# "
alreadyInstalled = "Already Installed"
continuePrompt = "\nClick [Return] to continue"

termsAndConditions = color.NOTICE + '''
I shall not use mwiriwe to:
...
'''
def agreement():
    while not config.getboolean("mwiriwe", "agreement"):
        clearScr()
        print(termsAndConditions)
        print(mrrobot4)
        agree = raw_input("You must agree to our terms and conditions first (y/n) ").lower()
        if agree in yes:
            config.set('mwiriwe', 'agreement', 'true')

class mwiriwe:
    def __init__(self):
        clearScr()
        self.createFolders()
        print (mwiriwelogo + color.RED + '''
       }--------------{+} Coded By dgatwist {+}--------------{
       }--------{+}  GitHub.com/dgatwist/mwiriwe {+}--------{
    ''' + color.END + '''
       ...
       {99}-EXIT\n
     ''')
        choice = raw_input(mwiriwePrompt)
        clearScr()
        if choice == "1":
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/dgatwist/mwiriwe.git")
        os.system("cd mwiriwe && bash ./update.sh")
        os.system("mwiriwe")
...
class sniffingSpoofingMenu:
    ...
    def __init__(self):
        ...
        choice6 = raw_input(mwiriwePrompt)
        clearScr()
        if choice6 == "1":
            setoolkit()
        elif choice6 == "2":
...
class webHackingMenu:
    ...
    def __init__(self):
        ...
        print("   {99}-Back To Main Menu \n")
        choiceweb = raw_input(mwiriwePrompt)
        clearScr()
        if choiceweb == "1":
            maine()
        elif choiceweb == "2":
...
class postExploitationMenu:
    ...
    def __init__(self):
        ...
        choice11 = raw_input(mwiriwePrompt)
        clearScr()
        if choice11 == "1":
            sitechecker()
        elif choice11 == "2":
...
class informationGatheringMenu:
    ...
    def __init__(self):
        ...
        print("  {8}--Crips\n  ")
        print("  {99}-Back To Main Menu \n")
        choice2 = raw_input(mwiriwePrompt)
        clearScr()
        if choice2 == "1":
            nmap()
        elif choice2 == "2":
...
class wirelessTestingMenu:
    ...
    def __init__(self):
        ...
        choice4 = raw_input(mwiriwePrompt)
        clearScr()
        if choice4 == "1":
            reaver()
        elif choice4 == "2":
...
class exploitationToolsMenu:
    ...
    def __init__(self):
        ...
        choice5 = raw_input(mwiriwePrompt)
        clearScr()
        if choice5 == "1":
            atscan()
        elif choice5 == "2":
